...
RSpec.describe LogParser::Processing::MostVisited do
  ...
  let(:loaded_data) do
    [
      LogParser::LogLine.new('/home', '127.0.0.1'),
      LogParser::LogLine.new('/about', '127.0.0.2'),
      LogParser::LogLine.new('/about', '127.0.0.3'),
      LogParser::LogLine.new('/about', '127.0.0.4'),
      LogParser::LogLine.new('/about', '127.0.0.5')
    ]
  end
